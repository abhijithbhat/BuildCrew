...
class _AddContributionScreenState extends State<AddContributionScreen> {
  ...
  void initState() {
    ...
    if (widget.initialAttachedFileName != null) {
      ...
      _attachedFileBytes = widget.initialAttachedFileBytes ??
          Uint8List.fromList(widget.initialAttachedFileName!.codeUnits);
    }
  ...
  Future<void> _restoreDraftIfAvailable() async {
    try {
      ...
      if (draft.isNotEmpty && mounted) {
        setState(() {
          if ((_resolvedProjectId == null || _resolvedProjectId!.isEmpty) &&
  ...
  Future<void> _pickDeviceImage(BuildContext modalCtx,
    ...
    try {
      ...
      if (picked != null) {
        ...
        final extension =
            name.contains('.') ? name.split('.').last.toLowerCase() : 'png';
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      ...
                      focusedErrorBorder: OutlineInputBorder(
                        borderRadius: BorderRadius.circular(12),
                        borderSide: const BorderSide(
                            color: Color(0xFFE11D48), width: 1.5),
                      ),
                    ),
                    validator: (value) {
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'Detail what you accomplished, key tools used, and how it impacts the team...',
                      hintStyle: const TextStyle(
                        color: Color(0xFFB0BEC5),
                        fontSize: 13,
                      ),
                  ...
                  TextFormField(
                    ...
                    decoration: InputDecoration(
                      hintText:
                          'https://figma.com/file/... or https://docs.google.com/...',
                      hintStyle: const TextStyle(
                        color: Color(0xFFB0BEC5),
                        fontSize: 13,
                      ),
